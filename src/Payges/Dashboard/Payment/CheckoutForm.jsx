    ...
    <div>
      <form onSubmit={handleSubmit}>
        ...
        <div className="mt-[64px]">
          <button
            className="w-[412px] min-h-[64px] bg-[#570DF8] rounded-lg text-white text-xl font-bold"
            type="submit"
            disabled={
              !stripe || !clientSecrete || processing
            }
          >
            Pay
          </button>
      ...
      {transactionId && (
        <p className="text-green-500">
          Transaction completed width transaction ID:{" "}
          {transactionId}
        </p>
      )}
    </div>
