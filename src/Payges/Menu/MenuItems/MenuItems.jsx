      ...
      <div className="max-w-screen-xl mx-auto mt-[150px]">
        ...
        <div className="grid justify-center my-[45px]">
          <Link to={`/ourShop/${heading}`}>
            <button className="btn btn-outline btn-[#BB8506] hover:text-[#BB8506] border-0 border-b-4 rounded-lg border-[#1F2937]  text-xl font-semibold uppercase text-[#1F2937]">
