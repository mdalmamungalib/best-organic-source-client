  ...
  return (
    <div>
      ...
      <div className="max-w-screen-xl mx-auto grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 justify-items-center gap-6">
        {recommends.slice(0, 3).map((recommend) => (
          <div key={recommend?._id} className=" w-96 bg-[#F3F3F3] shadow-xl">
            <img
            ...
            <div className="card-body items-center text-center">
              ...
              <div className="card-actions">
                <Link to="/ourShop/:category">
                  <button className="btn btn-outline btn-[#BB8506] hover:text-[#BB8506] border-0 border-b-4 rounded-lg border-[#BB8506]  text-xl font-semibold uppercase text-[#BB8506] mt-6">
                    add to cart
                  </button>
                </Link>
              </div>
