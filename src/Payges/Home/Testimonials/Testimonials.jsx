...
const Testimonials = () => {
    ...
    return (
        <div className="max-w-screen-xl mx-auto mb-[130px]">
            <SectionTitle
            ...
            <Swiper navigation={true} modules={[Navigation]} className="mySwiper">

                {
                    ...
                    >
                        ...
                        <div className="flex flex-col items-center mx-[64px] text-center">
                            <Rating
                                className="pb-[48px]"
                                style={{ maxWidth: 180 }}
                            ...
                            <div className="mb-3">
                                <h1>Product Image:</h1>
                                <PhotoProvider>
                                    <PhotoView src={review?.imgURL}>
                                        <img className="w-[180px]" src={review?.imgURL} style={{ objectFit: 'cover' }} alt="" />
                                    </PhotoView>
                                </PhotoProvider>
                            </div>
                            {/* <svg className="pb-[40px]" xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100" fill="none">
                            ...
                            <p className="text-[#444]">{review?.reviewDetail}</p>
                            <h3 className="text-[#CD9003] text-[32px] font-medium">{review?.recipeName}</h3>
                        </div>
                    </SwiperSlide>)
                }
            </Swiper>
